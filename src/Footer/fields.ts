/**
 * The Footer global's fields, kept apart from `config.ts` so the visual editor can convert
 * them into Puck fields. `config.ts` also carries the `revalidateFooter` hook, and that
