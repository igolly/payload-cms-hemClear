    ...
    >
      <div className="mx-auto max-w-4xl">
        <header className="flex flex-col items-center text-center">
          <BrandIcon className="text-brand-400 [&>svg]:h-12 [&>svg]:w-12" name="shieldCheck" />
        ...
        {pointItems.length > 0 && (
          <div className="mt-8 flex flex-col items-center gap-6 rounded-2xl border border-tint-100 bg-mist p-6 sm:flex-row sm:gap-8 sm:p-8">
            {/* Seal */}
            <div className="relative flex h-28 w-28 shrink-0 items-center justify-center">
              <span
                aria-hidden="true"
                className="absolute inset-0 rounded-full border-2 border-dotted border-tint-300"
              />
              <span className="flex h-20 w-20 flex-col items-center justify-center rounded-full bg-brand-400 leading-none text-white">
        ...
        {pills.length > 0 && (
          <ul className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {pills.map((pill, i) => (
              <li
                className="flex items-center gap-2 rounded-full border border-tint-150 px-5 py-2"
