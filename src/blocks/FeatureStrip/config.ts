      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Why — feature row (icon beside title, blue rules)', value: 'whyFeatures' },
            { label: 'Why — four icon columns under a heading', value: 'whyDifferent' },
            { label: 'Why — guarantees, CTA button and secure line', value: 'whyQuick' },
          ],
